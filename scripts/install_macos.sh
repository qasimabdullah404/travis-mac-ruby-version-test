...
cd $VCPKG_ROOT
vcpkg="./vcpkg install --x-install-root=$VCPKG_INSTALL_ROOT"

$vcpkg --triplet x64-osx openimageio opencolorio
$vcpkg --triplet x64-osx assimp
$vcpkg --triplet x64-osx SDL2
...
#./vcpkg install --x-install-root=$VCPKG_INSTALL_ROOT --triplet arm64-ios assimp SDL2
